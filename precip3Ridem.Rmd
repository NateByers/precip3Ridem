...
precipSubsetPlot <- function(data, site, site.col, date.col, precip.col, 
                             ...
                             file.prefix = NULL, file.extension = "png", ...){
...
station <- c("LMG-05-0009", "LM-05-0004")
...
for(i in 1:dim(scenarios)[1]){
  precipSubsetPlot(data = wide.precip.df, site = scenarios[i, "station"], 
...
```{r, eval=FALSE}
mapply(FUN = precipSubsetPlot, site = scenarios[, "station"], 
